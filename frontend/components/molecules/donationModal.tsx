...
export default function DonationModal() {
  ...
  return (
    <Modal isOpen={modalOpen} onOpenChange={setModalOpen} className="border border-[#00B0F0]">
      <ModalContent>
      <ModalHeader>
      ...
      <ModalBody>
        <div className="flex flex-col items-center space-y-4">
          <p className="text-lg text-center">
            If you find our platform useful, consider supporting us on Buy Me a Coffee.
          </p>
          <a

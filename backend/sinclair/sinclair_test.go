...
func TestCalcSinclair(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "1993-04-01"}, male: true},
			expectedSinclair: 261.68857,
		},
		{
			name:             "NormalSinclairMale2001",
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "2001-04-01"}, male: true},
			expectedSinclair: 261.68857,
		},
		{
			name:             "NormalSinclairMale2021",
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "2021-04-01"}, male: true},
			expectedSinclair: 298.24963,
		},
		{
			name:             "NormalSinclairMale2017",
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "2017-04-01"}, male: true},
			expectedSinclair: 285.66986,
		},
		{
			name:             "NormalSinclairFemale2021",
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "2021-04-01"}, male: false},
			expectedSinclair: 270.42316,
		},
		{
			name:             "NormalSinclairFemale2017",
			args:             args{result: &structs.Entry{Bodyweight: 81, Total: 235, Sinclair: 0, Date: "2020-04-01"}, male: false},
			expectedSinclair: 270.17587,
		},
		{
			name:             "Over-rangeSinclairMale",
			args:             args{result: &structs.Entry{Bodyweight: 160, Total: 510, Sinclair: 0, Date: "2021-04-01"}, male: true},
			expectedSinclair: 0,
		},
		{
			name:             "Over-rangeSinclairFemale",
			args:             args{result: &structs.Entry{Bodyweight: 160, Total: 510, Sinclair: 0, Date: "2021-04-01"}, male: false},
			expectedSinclair: 0,
		},
		{
			name:             "SuperHeavySinclairMale",
			args:             args{result: &structs.Entry{Bodyweight: 200, Total: 400, Sinclair: 0, Date: "2021-04-01"}, male: true},
			expectedSinclair: 400,
		},
		{
			name:             "SuperHeavySinclairFemale",
			args:             args{result: &structs.Entry{Bodyweight: 200, Total: 400, Sinclair: 0, Date: "2021-04-01"}, male: false},
			expectedSinclair: 400,
		},
	}

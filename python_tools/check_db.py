...
def assign_dataclass(data: list) -> Result:
    ...
    try:
        ...
        to_return = Result(
            ...
            category=data[2],
            lifter_name=data[3],
            bodyweight=to_float(data[4]),
            snatch_1=to_float(data[5]),
            snatch_2=to_float(data[6]),
            snatch_3=to_float(data[7]),
            cj_1=to_float(data[8]),
            cj_2=to_float(data[9]),
            cj_3=to_float(data[10]),
            best_snatch=to_float(data[11]),
            best_cj=to_float(data[12]),
            total=to_float(data[13]),
        )
        return to_return
